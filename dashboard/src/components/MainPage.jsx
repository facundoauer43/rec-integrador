...
export default function MainPage() {
  ...
  useEffect(() => {
    fetch("http://localhost:3001/api/productList")
      .then((req) => req.json())
...
La página web es una plataforma de comercio electrónico para comprar libros. Ofrece una amplia selección, detalles de los libros, reseñas y un proceso de compra sencillo con opciones de pago y envío.
        </h3>
      </div>
    </main>
  );
